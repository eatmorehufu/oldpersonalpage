...
Game.prototype.levelup = function() {
  ...
  var viewer = this.gameView;
  viewer.ctx.fillStyle = "white";
  viewer.ctx.font = 50 + "pt Helvetica";
  viewer.ctx.fillText("Level Up!", 0, 0)
  console.log(viewer.ctx);
